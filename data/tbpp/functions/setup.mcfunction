...
scoreboard objectives add tbpp_store_z dummy

scoreboard objectives add tbpp_jump minecraft.custom:minecraft.jump
scoreboard objectives add tbpp_sneak minecraft.custom:minecraft.sneak_time
